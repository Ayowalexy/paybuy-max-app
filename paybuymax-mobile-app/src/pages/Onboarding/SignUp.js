          ...
          {el.id % 2 === 1 ? (
            <View
              ...
              style={[
                ...
                {
                  backgroundColor:
                    el.state === "done" ? colors.primary : colors.white,
                  borderColor:
                    el.state === "ongoing" ? colors.primary : colors.line,
                },
              ]}
            >
              <Text
              ...
              >
                {el.id === 1 ? 1 : el.id === 3 ? 2 : el.id === 5 ? 3 : null}
              </Text>
            </View>
          ) : (
            <View style={styles.line_p}>
              <View
                style={[
                  ...
                  {
                    width:
                      el.state === "half" ? 20 : el.state === "full" ? 40 : 0,
                  },
                ]}
              />
            </View>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <HStack style={styles.footer}>
            <Text style={styles.accept}>Already have an account?</Text>

...
const Receive = ({ isPanelActive, setIsPanelActive, type, showSummary }) => {
                            ...
                            <View style={{ width: '90%' }}>
...

                                {
                                    banksAccounts.length === 0
                                        ? (
                                            <>
                                                <TouchableOpacity onPress={() => navigation.push('Add Bank')} style={styles.add}>
                                                    <Ionicons name="add" color={colors.black} size={20} />
                                                    <Text style={[styles.header, { paddingTop: 0 }]}>Add bank</Text>
                                                </TouchableOpacity>
                                            </>
                                        ) : (
                                            <>
                                                ...
                                                <DropDownPicker
                                                    ...
                                                    onSelectItem={(item) => {
                                                        setValue(item)
                                                        console.log(item)
                                                        setFieldTouched('bankaccount_id', true)
                                                        setFieldValue('bankaccount_id', item.value)
                                                        setFieldError('bankaccount_id', '')
                                                    }}
                                                    setValue={setValue}
                                                    setItems={setItems}
                                                    placeholder=' '
                                                    ...
                                                    style={{ backgroundColor: '#F4F4F4', borderWidth: 0, height: 60, marginTop: 35 }}
                                                />
                                                {
                                                    !!errors.bankaccount_id && touched.bankaccount_id && (
                                                        <Text style={styles.error}>Select a bank account</Text>
                                                    )
                                                }
                                            </>
                                        )

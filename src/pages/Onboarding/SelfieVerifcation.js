...
import { Selfie } from "../../utils/assets";


const SelfieVerifcation = ({ navigation }) => {
        ...
        <Layout head={() => <Header stats='1 half' />}>
            ...
            <ScrollView>
                <View style={styles.container}>
                    ...
                    <Image source={Selfie} style={styles.image} resizeMode='contain' />
                    ...
                    <Button onPress={() => navigation.push('Selfie Verification 2')} style={{ width: '80%', marginTop: 40 }} >
                        Open Camera
                    </Button>
                    <TouchableOpacity>
...
export default SelfieVerifcation